...
syn keyword sqlOperator	sysdate out join
syn match   sqlOperator	"\(left\|right\) outer join"
...
syn keyword sqlStatement truncate update constraint

syn keyword sqlType	boolean char character date float integer long
syn keyword sqlType	mlslabel number raw rowid varchar varchar2 varray int
