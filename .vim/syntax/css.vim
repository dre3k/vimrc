...
" dk_fix
syn keyword cssTagName mark nav header footer article aside section
...
" dk_fix
syn region cssURL contained matchgroup=cssFunctionName start="\<\(rgba\|lightness\|complement\|gutter\|columns\)\s*(" end=")" oneline keepend
...
" dk_fix
syn keyword cssBoxProp contained opacity
...
" dk_fix
syn keyword cssPagingProp contained style variant
...
syn match cssRenderProp contained "\<\(word-wrap\)\>"
