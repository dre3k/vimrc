...
function! s:BEMapKeys()
  ...
  nnoremap <buffer> <silent> <m-n>         :call <SID>BESelectBuffer()<cr>

  " dre3k_fix
  nnoremap <buffer> <silent> <m-a>         :call <SID>BESelectBuffer()<cr>
  nnoremap <buffer> <silent> <m-w>         :call <SID>BESelectBuffer()<cr>
  nnoremap <buffer> <silent> 1             :buffer 1<cr>
  nnoremap <buffer> <silent> 2             :buffer 2<cr>
  nnoremap <buffer> <silent> 3             :buffer 3<cr>
  nnoremap <buffer> <silent> 4             :buffer 4<cr>
  nnoremap <buffer> <silent> 5             :buffer 5<cr>
  nnoremap <buffer> <silent> 6             :buffer 6<cr>
  nnoremap <buffer> <silent> 7             :buffer 7<cr>
  nnoremap <buffer> <silent> 8             :buffer 8<cr>
  nnoremap <buffer> <silent> 9             :buffer 9<cr>
